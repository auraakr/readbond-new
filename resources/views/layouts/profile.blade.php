            ...
            <div class="bg-slate-900 border-b border-white/5">
                ...
                <div class="max-w-6xl mx-auto px-6">
                    <nav class="flex gap-1 overflow-x-auto scrollbar-hide">
                        @foreach(['Profile' => 'profile', 'Activity' => 'profile.activity', 'Books' => 'profile.books', 'Diary' => '#', 'Reviews' => 'profile.reviews', 'Readlist' => 'profile.readlist', 'Collections' => '#', 'Network' => '#'] as $tab => $routeName)
                            @php
